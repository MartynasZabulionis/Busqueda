...
def my_first_graph_search(problem):
    return graph_search(problem, MiPropiaCola())


def my_first_euristic_graph_search(problem):
    return graph_search(problem, MiPropiaEuristicaCola(problem))
